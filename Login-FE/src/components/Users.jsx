...
function Users() {
  ...
  const handleClose = (event) => {
    // needed to fix problem with select component causing clickaway
    // however this breaks clickaway from working... not sure how to fix long term
    setOpen(false);
  };
        ...
        <Stack direction="row">
          ...
          >
            ...
            <MaterialReactTable
              ...
              columns={columns}
              // turn off 1 of x row(s) selected message
              // localization={{
